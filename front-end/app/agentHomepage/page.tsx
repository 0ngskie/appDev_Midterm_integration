        ...
        <div className="flex items-center">
          ...
          <div className="flex space-x-2">
            ...
            <div className="flex items-center space-x-2">
              <Link href="/agentProfile" className="bg-[#FFC840] text-black py-1 px-2 rounded-lg text-[12px] font-montserrat font-bold">MY PROFILE</Link>
              <Link href="/" className="bg-white text-black py-1 px-2 rounded-full text-[12px] font-montserrat font-bold">Logout</Link>
            </div>
          </div>
        </div>
      </header>
